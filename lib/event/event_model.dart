...
class EventModel {
  ...
  factory EventModel.fromMap(Map<String, dynamic> map) {
    return EventModel(
      ...
      notes: map['note'] != null ? map['note'] as String : null,
  ...
  @override
  String toString() {
    return 'EventModel(id: $id, startTime: $startTime, endTime: $endTime, isAllDay: $isAllDay, subject: $subject, note: $notes, recurrenceRule: $recurrenceRule)';
  }
...
extension ExEvenntModel on EventModel {
