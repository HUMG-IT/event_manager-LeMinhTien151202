...
class _EventViewState extends State<EventView> {
  ...
  //tạo calendarcontroller điều khiển scaor
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      actions: [
        ...
        icon: getCalenndarViewIcon(calendarController.view!),
        ),
      ...
      body: SfCalendar(
        ...
        //Nhấn dữu vào cell để thêm sự kiện
        onLongPress:(details){
          //ko có sự kiện trong cell
        ...
        //chạm vào để xem lịch và sửa
        onTap: (details){
          //khi vhạm vào sự kiện -> sửa hoặc xóa
  ...
  //hàm lấy icon tương ứng vs calendar view
  Icon getCalenndarViewIcon(CalendarView view){
    switch (view) {
